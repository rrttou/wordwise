...
const sl = {
  ...
  heroBadge: {
    ...
    color: '#fff', fontSize: 11, fontWeight: 600, letterSpacing: '1px',
  },
  heroTitle: {
    fontFamily: "'Playfair Display', serif",
  ...
  heroCta: {
    background: '#ffffff', color: '#337ab7', border: 'none',
  ...
  heroNote: {
    color: 'rgba(255,255,255,0.55)', fontSize: 11, marginTop: 14,
  },
  statsStrip: {
  ...
  statVal: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 28, fontWeight: 700, color: '#337ab7',
  },
  ...
  ctaCard: {
    ...
    boxShadow: '0 4px 12px rgba(51,122,183,0.35)',
  },
  ctaTitle: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 24, fontWeight: 700, color: '#fff', marginBottom: 10,
  },
  ctaSub: { color: 'rgba(255,255,255,0.75)', fontSize: 13, marginBottom: 22 },
  ctaBtn: {
    background: '#fff', color: '#337ab7', border: 'none',
...
const s = {
  ...
  moduleName: { fontSize: 13, fontWeight: 600, marginBottom: 3, color: '#2c3e50' },
  moduleSub:  { fontSize: 11, color: '#999' },
  modTrack: {
    height: 4,
    background: '#eeeeee',
    borderRadius: 2,
