...
const sl = {
  hero: {
    background: 'linear-gradient(160deg, #09090b 0%, #0d1a14 60%, rgba(16,185,129,0.06) 100%)',
  ...
  heroBubble2: {
    ...
    background: 'rgba(16,185,129,0.04)', pointerEvents: 'none',
    filter: 'blur(30px)',
  },
  heroBadge: {
    ...
    color: c.mintD, fontSize: 11, fontWeight: 600, letterSpacing: '1px',
  },
  heroTitle: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 54, fontWeight: 700, color: c.ink,
    lineHeight: 1.05, marginBottom: 16, letterSpacing: '-1px',
  },
  heroSub: {
  ...
  heroNote: {
    color: c.ink3, fontSize: 11, marginTop: 14,
  },
  statsStrip: {
  ...
  statVal: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 28, fontWeight: 700, color: c.mintD,
  },
  ...
  ctaTitle: {
    fontFamily: "'Playfair Display', serif",
    fontSize: 24, fontWeight: 700, color: c.ink, marginBottom: 10,
  },
  ctaSub: { color: c.ink2, fontSize: 13, marginBottom: 22 },
  ctaBtn: {
    background: c.mint, color: '#09090b', border: 'none',
...
const s = {
  ...
  heroCard: {
    background: 'linear-gradient(135deg, #111113 0%, #0d1a14 100%)',
  ...
  moduleName: { fontSize: 13, fontWeight: 600, marginBottom: 3, color: c.ink },
